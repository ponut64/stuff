...
SRCS=main.c render.c tga.c vdp2.c mymath.c draw.c bounder.c collision.c player_phy.c hmap.c minimap.c hmap_col.c physobjet.c control.c msfs.c ZT/ZT_LOAD_MODEL.c ZT/ZT_TOOLS.c ZT/ZT_CD.c 
