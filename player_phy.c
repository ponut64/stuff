...
void	construct_line_tables(void)
{
	...
	you.time_axis.xp0[X] = fxm(fxm(pl_RBB.UVX[X],  pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.xp0[Y] = fxm(fxm(pl_RBB.UVX[Y],  pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.xp0[Z] = fxm(fxm(pl_RBB.UVX[Z],  pl_RBB.velocity[Z]), time_fixed_scale);
	you.time_axis.xp1[X] = fxm(fxm(pl_RBB.UVNX[X], pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.xp1[Y] = fxm(fxm(pl_RBB.UVNX[Y], pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.xp1[Z] = fxm(fxm(pl_RBB.UVNX[Z], pl_RBB.velocity[Z]), time_fixed_scale);
	you.time_axis.yp0[X] = fxm(fxm(pl_RBB.UVY[X],  pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.yp0[Y] = fxm(fxm(pl_RBB.UVY[Y],  pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.yp0[Z] = fxm(fxm(pl_RBB.UVY[Z],  pl_RBB.velocity[Z]), time_fixed_scale);
	you.time_axis.yp1[X] = fxm(fxm(pl_RBB.UVNY[X], pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.yp1[Y] = fxm(fxm(pl_RBB.UVNY[Y], pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.yp1[Z] = fxm(fxm(pl_RBB.UVNY[Z], pl_RBB.velocity[Z]), time_fixed_scale);
	you.time_axis.zp0[X] = fxm(fxm(pl_RBB.UVZ[X],  pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.zp0[Y] = fxm(fxm(pl_RBB.UVZ[Y],  pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.zp0[Z] = fxm(fxm(pl_RBB.UVZ[Z],  pl_RBB.velocity[Z]), time_fixed_scale);
	you.time_axis.zp1[X] = fxm(fxm(pl_RBB.UVNZ[X], pl_RBB.velocity[X]), time_fixed_scale);
	you.time_axis.zp1[Y] = fxm(fxm(pl_RBB.UVNZ[Y], pl_RBB.velocity[Y]), time_fixed_scale);
	you.time_axis.zp1[Z] = fxm(fxm(pl_RBB.UVNZ[Z], pl_RBB.velocity[Z]), time_fixed_scale);
