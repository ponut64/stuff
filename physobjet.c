...
/* level01? */
//Discocovery: if its X+, just add another 1 to its X.
...
declare_object_at_cell(-(780 / 40) + 1, -275, -(780 / 40), 21 /*wall1*/, 0, 180, 0, 0);
declare_object_at_cell(-(1020 / 40) + 1, -275, -(740 / 40), 21 /*wall1*/, 0, 0, 0, 0);
