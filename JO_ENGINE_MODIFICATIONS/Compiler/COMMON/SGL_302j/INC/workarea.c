...
#define		MAX_VERTICES	2	/* number of vertices that can be used */
#define		MAX_POLYGONS	3000	/* number of polygons that can be used */
#define		MAX_EVENTS		2	/* number of events that can be used   */
#define		MAX_WORKS		2	/* number of works that can be used    */
